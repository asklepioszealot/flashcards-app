  ...
  return normalizeSyncedUserState(
    {
      ...
      showReviewScheduleInfo: stateJson.showReviewScheduleInfo,
...
export function normalizeSyncedUserState(snapshot, fallbackUpdatedAt = nowIso()) {
  ...
  return {
    ...
    showReviewScheduleInfo: snapshot?.showReviewScheduleInfo === true,
  ...
  function mapSnapshotToStateRow(userId, snapshot) {
    ...
    return {
      ...
      state_json: {
        ...
        showReviewScheduleInfo: normalizedSnapshot.showReviewScheduleInfo,
